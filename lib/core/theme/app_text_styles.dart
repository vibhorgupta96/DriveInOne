...
class AppTextStyles {
  static const TextStyle headline1 = TextStyle(fontSize: 24, fontWeight: FontWeight.bold);
  static const TextStyle headline2 = TextStyle(fontSize: 20, fontWeight: FontWeight.w600);
  static const TextStyle headline3 = TextStyle(fontSize: 18, fontWeight: FontWeight.w600);
