...
void main() {
  ...
  test('replaceFacesForMedia never accumulates results from an earlier run',
      () async {
  ...
  test('media cleanup repairs representatives and prunes empty clusters',
      () async {
    ...
    await database.facesDao.insertCluster(FaceClustersCompanion.insert(
      id: 'cluster',
